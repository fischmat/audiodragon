...
import de.matthiasfisch.audiodragon.platform.JavaAudioPlatform
...
class AudioPlatformService(val settingsService: SettingsService) {
    private val platforms: Map<String, AudioPlatform> = BUILTIN_PLATFORMS.associateBy { it.platformId }
